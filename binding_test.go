...
type FooStruct struct {
	Foo string `msgpack:"foo" json:"foo" form:"foo" xml:"foo" valid:"required"`
}

type FooBarStruct struct {
	FooStruct
	Bar string `msgpack:"bar" json:"bar" form:"bar" xml:"bar" valid:"required"`
}

type FooDefaultBarStruct struct {
	FooStruct
	Bar string `msgpack:"bar" json:"bar" form:"bar,default=hello" xml:"bar" valid:"required"`
}

type FooStructUseNumber struct {
	Foo int64 `json:"foo" valid:"required"`
}
...
func TestExistsFails(t *testing.T) {
	type HogeStruct struct {
		Hoge *int `json:"foo" valid:"required"`
	}
...
func testBodyBindingUseNumber2(t *testing.T, b Binding, name, path, badPath, body, badBody string) {
	...
	assert.Equal(t, int64(123), obj.Foo)
